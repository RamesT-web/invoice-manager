...
import { Plus, FileText, Search, Loader2, Trash2, RotateCcw, ChevronLeft, ChevronRight, ArrowUpDown, ArrowUp, ArrowDown } from "lucide-react";
...
export default function BillOfSupplyPage() {
  ...
  const [sortBy, setSortBy] = useState<SortField>("invoiceNumber");
            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th>
                    <button onClick={() => toggleSort("customerName")} className="flex items-center hover:text-blue-600 transition-colors">
                      Customer <SortIcon field="customerName" />
                    </button>
                  </th>
                  <th className="w-[110px]">
                    <button onClick={() => toggleSort("invoiceDate")} className="flex items-center hover:text-blue-600 transition-colors">
